...
r4 = Review.create(service_id: s4.id, user_id: u5.id, description: "Savage", rating: 5.00)
r5 = Review.create(service_id: s5.id, user_id: u6.id, description: "Great bass skills", rating: 5.00)
