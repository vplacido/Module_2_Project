...
l4 = Listing.create(user_id: u7.id, title: "Bass Guitarist Needed", description: "Cover the bass guitar line for Get Lucky", time_frame: "15 hours", price: 40.00, packages: false)
l5 = Listing.create(user_id: u2.id, title: "Mokbang", description: "I want to watch someone live octopus with asmr mic", time_frame: "1 hour", price: 10.00, packages: false)
